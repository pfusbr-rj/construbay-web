...
const FAQS = [
  {
    ...
    a: 'ADU construction in Marin County ranges from $185,000 for a garage conversion to $650,000+ for a custom detached unit. ConstruBay provides fixed-scope contracts — what we quote is what you pay.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. All ADUs in Marin County require building permits. Some jurisdictions also require Design Review Board approval. ConstruBay handles the entire permit process using our AI-powered PlanPass.ai platform.',
  },
  {
    q: 'What ADU types does ConstruBay build in Marin County?',
    a: 'We build detached ADUs, attached ADUs, garage conversions, and Junior ADUs (JADUs) across Mill Valley, San Rafael, Tiburon, Novato, and surrounding areas.',
  },
  {
    q: 'Why choose ConstruBay over other Marin County ADU contractors?',
    a: 'We are the only contractor in Marin County using AI-powered permit intelligence (PlanPass.ai), we offer fixed-scope contracts with no surprise change orders, and Paulo leads every project personally from site visit to final walkthrough.',
  },
  {
    ...
    <div style={{ backgroundColor: '#000', color: GOLD, fontFamily: MS, minHeight: '100vh' }}>
      ...
      >
        ...
        >
          ...
          >
            Design-build ADU construction in Marin County. AI-accelerated permitting across all 11 Marin jurisdictions.
      ...
      <section style={{ padding: '100px 24px', backgroundColor: '#050505' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          >
            No other contractor in Marin County offers this.
          </p>
          <p
            style={{
              fontFamily: MS,
      ...
      >
        ...
        >
          Marin County ADU permits take 4&ndash;8 months across 11 jurisdictions. We accept a limited number of
