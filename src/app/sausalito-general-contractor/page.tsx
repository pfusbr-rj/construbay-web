...
const city = getCityBySlug('sausalito');

export const metadata: Metadata = city ? generateCityMetadata(city) : {};

const faqs = [
  {
    q: 'How complex is permitting in Sausalito compared to other Marin cities?',
    a: 'Sausalito is among the more complex permitting jurisdictions in Marin. Hillside, coastal, and historic overlay zones can all apply simultaneously to a single property. We recommend budgeting 12–16 weeks for permit review and often work with permit expediters for time-sensitive projects.',
  },
  {
    q: 'Do you work on hillside homes in Sausalito?',
    a: 'Yes — hillside construction is a specialty of ours. We\'re experienced with engineered retaining walls, soil reports, and the specific structural requirements for steep-slope sites common in Sausalito.',
  },
  {
    q: 'Are you familiar with Sausalito\'s historic district regulations?',
    a: 'Yes. Parts of Sausalito fall within historic overlay zones with design review requirements. We work with the planning department early in the design process to ensure compliance before spending on detailed drawings.',
  },
  {
    q: 'Do you build ADUs in Sausalito?',
    a: 'Yes. ADU feasibility in Sausalito depends heavily on lot size, slope, and applicable setbacks. We provide a free feasibility assessment before any design work begins.',
  },
  {
    q: 'What areas of Sausalito do you serve?',
    a: 'We work throughout Sausalito including the Banana Belt, Hurricane Gulch, Wolfback Ridge, and the Marinship area.',
  },
];
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start' }}>
              <div>
                ...
                <p className={montserrat.className} style={{ fontSize: '13px', fontWeight: '300', color: 'rgba(255,255,255,0.6)', lineHeight: 1.9, marginBottom: '20px' }}>
                  Sausalito&apos;s combination of hillside terrain, bay views, and architectural character makes it one of the most rewarding — and demanding — places to build in the Bay Area. ConstruBay brings the expertise to navigate its complexities.
                </p>
