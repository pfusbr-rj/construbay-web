...
const city = getCityBySlug('corte-madera');

export const metadata: Metadata = city ? {
  ...generateCityMetadata(city),
  title: 'General Contractor Corte Madera CA | Luxury Home Remodeling Corte Madera | ConstruBay',
  description: 'Licensed luxury general contractor in Corte Madera CA. Full home remodels, kitchen & bath, ADUs. Southern Marin, Corte Madera Hills, Murray Park. CSLB #1106798.',
} : {};

const faqs = [
  {
    q: 'Does ConstruBay work in Corte Madera?',
    a: 'Yes. We have completed projects throughout Corte Madera, including Corte Madera Hills, Murray Park, and Old Town. Corte Madera\'s combination of family homes and hillside properties creates a variety of remodeling opportunities we are well equipped to handle.',
  },
  {
    q: 'What is the permit process like in Corte Madera?',
    a: 'Corte Madera has its own building department. Most residential permits take 6–10 weeks for standard projects. Projects involving lot coverage changes, hillside grading, or ADU construction may have additional review requirements. We manage the entire permit process on your behalf.',
  },
  {
    q: 'Can you build ADUs in Corte Madera?',
    a: 'Yes. ADU construction is a significant area of our work throughout southern Marin. We handle the full ADU process — design, permitting, and construction — and understand Corte Madera\'s specific ADU ordinance requirements.',
  },
  {
    q: 'What types of projects do you complete in Corte Madera?',
    a: 'Full home renovations, kitchen and bathroom remodels, ADUs, home additions, and outdoor living spaces. We work on both focused room-by-room renovations and complete whole-home transformations.',
  },
  {
    q: 'What is your minimum project size in Corte Madera?',
    a: 'We typically work on projects starting at $150,000. In Corte Madera we complete full home renovations, ADU builds, and focused kitchen and bath renovations across a wide range of scopes.',
  },
];
    ...
    '@graph': [
      {
        ...
        name: 'ConstruBay',
        description: 'Licensed luxury general contractor serving Corte Madera, CA. Full home remodels, ADUs, kitchen and bath renovations. CSLB #1106798.',
        url: 'https://www.construbay.com/corte-madera-general-contractor',
        ...
        areaServed: ['Corte Madera', 'Larkspur', 'Tiburon', 'Mill Valley', 'Sausalito', 'Marin County'],
        hasCredential: {
    ...
    <>
      ...
      <main style={{ backgroundColor: '#000000', minHeight: '100vh' }}>
        ...
        <section style={{ position: 'relative', height: '60vh', minHeight: '480px' }}>
          ...
          <img
            src={city.heroImage}
            alt="General contractor in Corte Madera, CA — ConstruBay CSLB #1106798"
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '64px 48px', maxWidth: '900px' }}>
            ...
            <h1 className={cormorant.className} style={{ fontSize: 'clamp(36px, 5vw, 64px)', fontWeight: '300', color: '#ffffff', lineHeight: 1.1, marginBottom: '20px' }}>
              Licensed General Contractor<br />Corte Madera, California
            </h1>
        ...
        <div className="max-w-5xl mx-auto px-6">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start' }}>
              <div>
                ...
                <p className={montserrat.className} style={{ fontSize: '13px', fontWeight: '300', color: 'rgba(255,255,255,0.6)', lineHeight: 1.9, marginBottom: '20px' }}>
                  Corte Madera is one of southern Marin&apos;s most sought-after communities — with easy freeway access, excellent schools, and a mix of flat family neighborhoods and hillside properties that offer some of the best views in the county.
                </p>
                <p className={montserrat.className} style={{ fontSize: '13px', fontWeight: '300', color: 'rgba(255,255,255,0.6)', lineHeight: 1.9 }}>
                  ConstruBay works with Corte Madera homeowners on everything from focused kitchen and bathroom renovations to full home transformations and ADU builds. Every project is managed personally by Paulo Fernandes. CSLB Licensed #1106798.
                </p>
              </div>
              <div>
                {[
          ...
          <section style={{ padding: '80px 0', borderBottom: '1px solid rgba(203,178,106,0.15)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2px' }}>
              {[
                { title: 'Full Home Remodels', desc: 'Complete renovation of Corte Madera homes — from hillside properties with bay views to flat-lot family homes.' },
                { title: 'Kitchen & Bath', desc: 'Custom cabinetry, stone surfaces, and precision craftsmanship for the heart of your home.' },
                { title: 'ADUs & Additions', desc: 'Fully permitted ADUs and additions. We navigate Corte Madera\'s building department and maximize your lot\'s potential.' },
                { title: 'Outdoor Living', desc: 'Decks, patios, and landscaped spaces designed to extend Corte Madera living to the outdoors year-round.' },
              ].map((service) => (
