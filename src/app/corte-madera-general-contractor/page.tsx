...
export const metadata: Metadata = {
  title: 'General Contractor Corte Madera CA | Luxury Home Remodeling | ConstruBay CSLB #1106798',
  description: 'Licensed luxury general contractor in Corte Madera CA. Full home remodels, ADUs, kitchen and bathroom renovations. Central Marin location. CSLB #1106798.',
  alternates: { canonical: 'https://www.construbay.com/corte-madera-general-contractor' },
}
...
const jsonLd = {
  ...
  areaServed: ['Corte Madera', 'Larkspur', 'Mill Valley', 'Marin County'],
}
...
const differentiators = [
  { n: '01', t: 'Central Marin Expertise', b: 'Corte Madera&apos;s mix of waterfront, hillside and flat properties requires versatile construction expertise we have built over years of Marin County projects.' },
  { n: '02', t: 'Town Permit Relationships', b: 'We manage the entire permit process with the Town of Corte Madera building department.' },
...
const faqs = [
  { q: 'Is ConstruBay licensed to work in Corte Madera?', a: 'Yes. ConstruBay holds California Contractors State License #1106798. Fully licensed, bonded and insured for all residential work throughout Corte Madera and Marin County.' },
  { q: 'What services does ConstruBay offer in Corte Madera?', a: 'We offer full home remodels, ADU construction, kitchen remodeling, bathroom remodeling and outdoor living projects throughout Corte Madera.' },
  { q: 'How do permits work in Corte Madera?', a: 'Corte Madera has its own building department. We manage the entire permit process from application to final approval.' },
  { q: 'Do you work in Marin Islands and waterfront areas of Corte Madera?', a: 'Yes. We serve all Corte Madera neighborhoods including waterfront properties, Marin Islands and the hillside areas above town.' },
]

export default function CorteMaderaGeneralContractorPage() {
  return (
    <>
      ...
      <main style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
        ...
        <section style={{ padding: '8rem 2rem 4rem', maxWidth: '1200px', margin: '0 auto' }}>
          <p style={{ color: '#cbb26a', fontFamily: MS, fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>General Contractor · Corte Madera, CA</p>
          ...
          <p style={{ color: '#cbb26a', fontFamily: CG, fontStyle: 'italic', fontSize: 'clamp(1.1rem, 2vw, 1.4rem)', marginBottom: '1.5rem' }}>
            Luxury Home Remodeling in Central Marin County
          </p>
          <p style={{ color: '#aaa', fontFamily: MS, fontSize: '0.85rem', lineHeight: 1.8, maxWidth: '650px', marginBottom: '2rem' }}>
            Corte Madera sits at the heart of Marin County — connecting Mill Valley, Larkspur and the greater Bay Area. From waterfront properties to hillside homes, ConstruBay delivers fixed-price luxury renovations with the precision and accountability central Marin homeowners deserve. CSLB #1106798.
          </p>
        ...
        <section style={{ padding: '4rem 2rem', textAlign: 'center', borderTop: '1px solid #1a1a1a' }}>
          <h2 style={{ fontFamily: CG, fontWeight: 300, fontSize: 'clamp(1.8rem, 3vw, 2.5rem)', marginBottom: '1rem' }}>
            Start Your Corte Madera Project
          </h2>
