...
export const metadata: Metadata = {
  title: 'Kitchen Remodel Tiburon CA | Luxury Kitchen Renovation | ConstruBay CSLB #1106798',
  description: 'Luxury kitchen remodeling in Tiburon CA. Custom cabinetry, premium appliances, bay view kitchens. $185k-$595k. Fixed-price contracts. CSLB #1106798.',
  alternates: { canonical: 'https://www.construbay.com/tiburon-kitchen-remodel' },
}
  ...
  '@graph': [
    {
      '@type': 'LocalBusiness',
      name: 'ConstruBay',
      description: 'Luxury kitchen remodeling in Tiburon CA. Custom cabinetry, premium appliances, bay view kitchens. CSLB #1106798.',
      url: 'https://www.construbay.com/tiburon-kitchen-remodel',
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'How much does a kitchen remodel cost in Tiburon?', acceptedAnswer: { '@type': 'Answer', text: 'Luxury kitchen remodels in Tiburon range from $185,000 for a compact kitchen to $595,000+ for a large gourmet kitchen with bay views. All quotes include permits, materials, appliances and our 10-year warranty.' } },
        { '@type': 'Question', name: 'How long does a kitchen remodel take in Tiburon?', acceptedAnswer: { '@type': 'Answer', text: 'Kitchen remodels in Tiburon typically take 10–20 weeks. Custom cabinetry requires 12 weeks fabrication lead time.' } },
        { '@type': 'Question', name: 'Does ConstruBay handle Tiburon kitchen permits?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We manage all permits with the Town of Tiburon building department from application to final approval.' } },
        { '@type': 'Question', name: 'Can ConstruBay design a kitchen around Tiburon bay views?', acceptedAnswer: { '@type': 'Answer', text: 'Absolutely. Tiburon kitchens are often designed to maximize bay and water views. We work with your architect or our design partners to create a kitchen that frames the extraordinary Tiburon setting.' } },
      ],
    },
  ],
}
...
const steps = [
  { n: '01', t: 'Site Visit', b: 'Paulo reviews your kitchen, understands your vision and assesses the bay view opportunities.' },
...
const faqs = [
  { q: 'How much does a kitchen remodel cost in Tiburon?', a: 'Luxury kitchen remodels in Tiburon range from $185,000 for a compact kitchen to $595,000+ for a large gourmet kitchen with bay views. All quotes include permits, materials, appliances and our 10-year warranty.' },
  { q: 'How long does a kitchen remodel take in Tiburon?', a: 'Kitchen remodels in Tiburon typically take 10–20 weeks. Custom cabinetry requires 12 weeks fabrication lead time.' },
  { q: 'Does ConstruBay handle Tiburon kitchen permits?', a: 'Yes. We manage all permits with the Town of Tiburon building department from application to final approval.' },
  { q: 'Can ConstruBay design a kitchen around Tiburon bay views?', a: 'Absolutely. Tiburon kitchens are often designed to maximize bay and water views. We work with your architect or our design partners to create a kitchen that frames the extraordinary Tiburon setting.' },
]

export default function TiburonKitchenRemodelPage() {
  return (
    <>
      ...
      <main style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
        ...
        <section style={{ padding: '8rem 2rem 4rem', maxWidth: '1200px', margin: '0 auto' }}>
          <p style={{ color: '#cbb26a', fontFamily: MS, fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '1rem' }}>Kitchen Remodeling · Tiburon, CA</p>
          <h1 style={{ fontFamily: CG, fontWeight: 300, fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.1, marginBottom: '1rem' }}>
            Luxury Kitchen Remodel —<br />Tiburon, California
          </h1>
          <p style={{ color: '#cbb26a', fontFamily: CG, fontStyle: 'italic', fontSize: 'clamp(1.1rem, 2vw, 1.4rem)', marginBottom: '1.5rem' }}>
            Custom Luxury Kitchens with Bay Views
          </p>
          <p style={{ color: '#aaa', fontFamily: MS, fontSize: '0.85rem', lineHeight: 1.8, maxWidth: '650px', marginBottom: '2rem' }}>
            Tiburon kitchens are designed around one of the most spectacular settings in California — bay views, waterfront light and the natural beauty of the Marin Peninsula. ConstruBay builds luxury kitchens that frame this setting with custom cabinetry, premium appliances and precision craftsmanship. Fixed-price. 10-year warranty. CSLB #1106798.
          </p>
