  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What is included in a ConstruBay kitchen remodel in Mill Valley?', acceptedAnswer: { '@type': 'Answer', text: 'Every kitchen remodel includes custom cabinetry, stone countertops, professional appliances, electrical upgrades, plumbing, lighting, permits and our 10-year warranty.' } },
      ],
    },
  ],
}
