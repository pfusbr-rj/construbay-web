...
gtag('config', 'G-E5R2DP0WG0');`,
      ...
      >
        ...
        <div style={{
          ...
          {[
            {
              href: "https://instagram.com/construbay",
              label: "Instagram",
            ...
            {
              href: "https://facebook.com/construbay",
              label: "Facebook",
            ...
            {
              href: "https://nextdoor.com/pages/construbay-mill-valley-ca-1",
              label: "Nextdoor",
            ...
            {
              href: "https://linkedin.com/in/construbay",
              label: "LinkedIn",
