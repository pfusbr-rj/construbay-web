...
const city = getCityBySlug('larkspur');

export const metadata: Metadata = city ? {
  ...generateCityMetadata(city),
  title: 'General Contractor Larkspur CA | Luxury Home Remodeling Larkspur | ConstruBay',
  description: 'Licensed luxury general contractor in Larkspur CA. Full home remodels, kitchen & bath, ADUs in Greenbrae, Baltimore Canyon, and Downtown Larkspur. CSLB #1106798.',
} : {};

const faqs = [
  {
    q: 'Does ConstruBay work in Larkspur and Greenbrae?',
    a: 'Yes. We have completed projects throughout Larkspur, Greenbrae, and Baltimore Canyon. We are experienced with the range of architectural styles in Larkspur — from the historic Victorian downtown to the newer construction in Greenbrae and the hillside estates of Baltimore Canyon.',
  },
  {
    q: 'What are permit timelines like in Larkspur?',
    a: 'Larkspur residential permits typically take 6–10 weeks. Projects in the historic downtown area may require design review and additional approval time. We build these timelines into every project schedule from day one.',
  },
  {
    q: 'Can you work on historic homes in Downtown Larkspur?',
    a: 'Absolutely. Historic preservation work requires careful attention to material matching and architectural character. We have experience working with Larkspur\'s design review process and the constraints of older homes with character worth protecting.',
  },
  {
    q: 'What types of projects do you handle in Larkspur?',
    a: 'Full home renovations, kitchen and bathroom remodels, ADUs, home additions, and outdoor living projects. We work on everything from complete whole-home transformations to focused primary suite renovations.',
  },
  {
    q: 'What is the minimum project investment for Larkspur?',
    a: 'We typically work on projects starting at $150,000. In Larkspur we work on focused renovations as well as whole-home transformations. For precise pricing see our investments page.',
  },
];
    ...
    '@graph': [
      {
        ...
        name: 'ConstruBay',
        description: 'Licensed luxury general contractor serving Larkspur, CA. Full home remodels, ADUs, kitchen and bath renovations. CSLB #1106798.',
        url: 'https://www.construbay.com/larkspur-general-contractor',
        ...
        areaServed: ['Larkspur', 'Greenbrae', 'Corte Madera', 'Kentfield', 'San Anselmo', 'Marin County'],
        hasCredential: {
    ...
    <>
      ...
      <main style={{ backgroundColor: '#000000', minHeight: '100vh' }}>
        ...
        <section style={{ position: 'relative', height: '60vh', minHeight: '480px' }}>
          ...
          <img
            src={city.heroImage}
            alt="General contractor in Larkspur, CA — ConstruBay CSLB #1106798"
        ...
        <div className="max-w-5xl mx-auto px-6">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start' }}>
              <div>
                ...
                <p className={montserrat.className} style={{ fontSize: '13px', fontWeight: '300', color: 'rgba(255,255,255,0.6)', lineHeight: 1.9, marginBottom: '20px' }}>
                  Larkspur offers some of central Marin&apos;s most diverse architecture — from the Victorian streetscapes of downtown to the waterfront properties of Greenbrae and the estate homes perched above Baltimore Canyon. Each neighborhood has its own character and its own construction challenges.
                </p>
                <p className={montserrat.className} style={{ fontSize: '13px', fontWeight: '300', color: 'rgba(255,255,255,0.6)', lineHeight: 1.9 }}>
                  ConstruBay brings the same standard of craftsmanship to every Larkspur project — whether restoring a historic downtown Victorian or building a contemporary whole-home renovation in Greenbrae. Every project is managed personally by Paulo Fernandes. CSLB Licensed #1106798.
                </p>
              </div>
              <div>
                {[
          ...
          <section style={{ padding: '80px 0', borderBottom: '1px solid rgba(203,178,106,0.15)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2px' }}>
              {[
                { title: 'Full Home Remodels', desc: 'Complete renovation across all of Larkspur\'s neighborhoods — downtown Victorian, Greenbrae waterfront, and Baltimore Canyon hillside.' },
                { title: 'Kitchen & Bath', desc: 'Precision cabinetry, stone work, and craftsmanship suited to Larkspur\'s varied architectural character.' },
                { title: 'ADUs & Additions', desc: 'Fully permitted accessory dwelling units and additions designed for Marin County\'s review process.' },
                { title: 'Outdoor Living', desc: 'Terraces, decks, and outdoor spaces that take advantage of Larkspur\'s natural setting and bay proximity.' },
              ].map((service) => (
