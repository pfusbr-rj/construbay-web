...
export default function FlooringPage() {
  ...
  const included: string[] = [
    "Wide-plank European oak & domestic hardwood installation",
    "Reclaimed & antique hardwood sourcing & installation",
    "Natural marble, travertine & limestone installation",
    "Custom inlay & border design",
    "Subfloor leveling, moisture mitigation & preparation",
    "Radiant heat flooring compatibility & installation",
    "Hardwood refinishing & stain matching",
    "Stone fabrication, sealing & maintenance programs",
  ];
  const faqs: { q: string; a: string }[] = [
    {
      q: "How much does luxury flooring installation cost in Marin County?",
      a: "Luxury flooring installation in Marin County typically ranges from $20,000 to $85,000+ for a full home depending on square footage and material selection. Wide-plank European oak typically runs $18–$35 per square foot installed. Natural stone (marble, travertine) runs $25–$65 per square foot installed including fabrication. Reclaimed hardwood with custom finishing can run $40–$80 per square foot. All ConstruBay flooring projects include subfloor preparation, moisture testing, and permits where required.",
    },
    {
      q: "What is the best hardwood flooring for Marin County's climate?",
      a: "For Marin County's humidity-variable climate, we recommend wide-plank engineered hardwood for ground-level and radiant-heat applications, and solid hardwood for upper floors where dimensional stability is less of a concern. White oak is our most-specified species — it has a wide, consistent grain that works with both traditional and contemporary aesthetics, and its dimensional stability is excellent compared to more exotic species. European oak with wire-brushed or natural oil finishes is the dominant specification on luxury Marin County renovations.",
    },
    {
      q: "Can hardwood floors be installed over radiant heat in Marin County?",
      a: "Yes — with the correct product specification and installation protocol. Solid hardwood over radiant heat is not recommended due to the dimensional movement caused by temperature cycling. We specify engineered hardwood products with a minimum 4mm wear layer for radiant applications, and we coordinate the heating system commissioning and maximum operating temperature with the flooring manufacturer's specifications. We have installed flooring over radiant systems throughout Mill Valley, Tiburon, and Sonoma County.",
    },
    {
      q: "Do hardwood floor installations require a permit in Marin County?",
      a: "Generally, no — flooring installation does not typically require a building permit in Marin County or most incorporated cities within the county, unless it involves subfloor structural modifications or is part of a larger permitted remodel. However, if your flooring project includes subfloor reconstruction, radiant heat system installation, or is part of a permitted renovation, it will be included in the relevant permit scope. ConstruBay advises on permit requirements during the initial consultation.",
    },
  ];
  const relatedServices: { name: string; href: string; desc: string }[] = [
    { name: "Kitchen Remodel", href: "/services/kitchen-remodel-marin-county", desc: "Bespoke culinary spaces with imported stone & professional appliances" },
  ...
  return (
    <div style={{ backgroundColor: "#000000", color: "#ffffff", fontFamily: MS }}>
      ...
      <section style={{ position: "relative", minHeight: "72vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <img src="/images/services/flooring-hero.jpg" alt="Wide-plank white oak hardwood flooring in a luxury residential interior" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.3 }} />
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "860px", padding: "0 24px" }}>
          ...
          <h1 style={{ fontFamily: CG, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: 300, color: "#ffffff", lineHeight: 1.05, marginBottom: "24px" }}>Luxury Flooring in Marin County</h1>
          <p style={{ fontFamily: MS, fontSize: "13px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.65)", marginBottom: "40px" }}>Wide-Plank Hardwood &amp; Natural Stone — The Foundation of Every Elevated Interior</p>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "96px 24px" }}>
        <p style={{ fontFamily: CG, fontSize: "clamp(1.2rem, 2.5vw, 1.6rem)", fontWeight: 300, color: "rgba(255,255,255,0.9)", lineHeight: 1.85, marginBottom: "32px" }}>The floor is the largest continuous surface in your home and the foundation of every aesthetic decision above it. We install wide-plank European oak, reclaimed hardwood, and natural stone flooring systems with the precision and attention to acclimation, substrate preparation, and expansion management that Marin County&apos;s humidity-variable climate demands.</p>
        <p style={{ fontFamily: CG, fontSize: "clamp(1.2rem, 2.5vw, 1.6rem)", fontWeight: 300, color: "rgba(255,255,255,0.9)", lineHeight: 1.85, marginBottom: "32px" }}>Flooring failure is almost always a substrate and acclimation problem rather than a material problem. We conduct moisture testing of every concrete subfloor and structural assessment of every wood subfloor before material delivery, and we require proper acclimation periods for all hardwood products before installation begins. The result is a floor that remains stable, beautiful, and gap-free for decades.</p>
        <p style={{ fontFamily: MS, fontSize: "12px", letterSpacing: "0.07em", color: "rgba(255,255,255,0.45)", lineHeight: 1.9 }}>ConstruBay (CSLB #1106798) is based in Mill Valley and has executed luxury flooring installation projects across Marin, Sonoma, and Napa Counties.</p>
      </section>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "96px 24px" }}>
        ...
        <p style={{ fontFamily: MS, fontSize: "14px", lineHeight: 1.95, color: "rgba(255,255,255,0.7)", letterSpacing: "0.03em" }}>Hardwood flooring in Marin County requires careful attention to the region&apos;s significant seasonal humidity variation — wet winters and dry summers create expansion and contraction cycles that, if not properly managed, cause cupping, gapping, and squeaking in improperly installed floors. We conduct pre-installation moisture testing and require minimum acclimation periods for all solid hardwood products. For radiant heat systems — increasingly common in Marin County luxury renovations — we specify engineered hardwood products with appropriate dimensional stability ratings, and we coordinate the heating system commissioning schedule with the flooring installation timeline.</p>
      </section>
      ...
      <section style={{ maxWidth: "680px", margin: "0 auto", padding: "96px 24px", textAlign: "center" }}>
        ...
        <div style={{ border: "1px solid rgba(203,178,106,0.25)", padding: "48px 32px", marginBottom: "28px" }}>
          <p style={{ fontFamily: CG, fontSize: "clamp(1.8rem, 4vw, 2.6rem)", fontWeight: 300, color: "#ffffff", marginBottom: "8px" }}>$20,000 – $85,000+</p>
      ...
      <section style={{ padding: "120px 24px", textAlign: "center", backgroundColor: "#000000" }}>
        ...
        <h2 style={{ fontFamily: CG, fontSize: "clamp(2.5rem, 5vw, 4rem)", fontWeight: 300, background: GRAD, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "24px", lineHeight: 1.1 }}>Begin Your Flooring Project</h2>
