...
export default function DrivewaysHardscapePage() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);
  const included: string[] = [
    "Natural stone & permeable paver driveway systems",
    "Bluestone & granite patio construction",
    "Retaining wall design & construction",
    "Motor court & turnaround engineering",
    "Concrete driveway with exposed aggregate or brushed finish",
    "Drainage swale & stormwater management integration",
    "Landscape lighting integration",
    "Curbing, edging & transition systems",
  ];
  const faqs: { q: string; a: string }[] = [
    {
      q: "How much does a luxury driveway cost in Marin County?",
      a: "A luxury driveway in Marin County typically ranges from $35,000 to $150,000+ depending on length, material, and site complexity. Natural stone paver driveways run $40–$85 per square foot installed including subbase and edging. Poured concrete with premium finish runs $20–$45 per square foot. Hillside driveways with significant grading and retaining wall work add meaningful cost depending on the extent of earthwork required. ConstruBay provides fixed-scope pricing inclusive of all engineering and permits.",
    },
    {
      q: "Do I need a permit for a driveway in Marin County?",
      a: "Yes — most new driveways, driveway expansions, and significant hardscape projects require permits from Marin County Public Works or the relevant city jurisdiction. Projects that disturb more than a minimum soil area may also require stormwater compliance documentation. ConstruBay manages all permit applications and stormwater compliance documentation using our PlanPass.ai platform.",
    },
    {
      q: "What driveway materials work best in Marin County?",
      a: "Permeable concrete pavers are our most-specified driveway material for Marin County — they satisfy stormwater LID requirements, provide excellent durability, and are available in natural stone aesthetics. For estates where appearance is the primary driver, we also install imported bluestone, Portuguese limestone, and granite sett cobblestone on sealed subbase systems with perimeter drainage. We do not recommend asphalt for luxury estate applications due to its aesthetic limitations and maintenance requirements.",
    },
    {
      q: "Can you build a driveway on a steep hillside lot in Marin County?",
      a: "Yes — hillside driveway engineering is one of our specialties. We have built driveways on lots with grades up to 25% throughout Mill Valley, Tiburon, and unincorporated Marin County. Steep-grade driveways require engineered subbase systems, often with reinforced concrete or paver systems with special mortared joints, proper drainage channels, and sometimes retaining structures. All hillside driveway projects receive a full geotechnical review as part of our initial assessment.",
    },
  ];
  ...
  return (
    <div style={{ backgroundColor: "#000000", color: "#ffffff", fontFamily: MS }}>
      ...
      <section style={{ position: "relative", minHeight: "72vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <img src="/images/services/driveways-hero.jpg" alt="Grand estate driveway with permeable pavers and stone entrance" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", opacity: 0.3 }} />
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "860px", padding: "0 24px" }}>
          ...
          <h1 style={{ fontFamily: CG, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: 300, color: "#ffffff", lineHeight: 1.05, marginBottom: "24px" }}>Driveways &amp; Hardscape in Marin County</h1>
          <p style={{ fontFamily: MS, fontSize: "13px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.65)", marginBottom: "40px" }}>Grand Entrances &amp; Permeable Stone Hardscaping — First Impressions Engineered</p>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "96px 24px" }}>
        <p style={{ fontFamily: CG, fontSize: "clamp(1.2rem, 2.5vw, 1.6rem)", fontWeight: 300, color: "rgba(255,255,255,0.9)", lineHeight: 1.85, marginBottom: "32px" }}>The approach to your estate sets expectations for everything inside it. We engineer grand driveway entrances and estate hardscape systems using permeable pavers, natural bluestone, granite, and decomposed granite — materials that combine architectural beauty with the drainage performance required on Marin County&apos;s hillside properties and urban lots subject to stormwater management requirements.</p>
        <p style={{ fontFamily: CG, fontSize: "clamp(1.2rem, 2.5vw, 1.6rem)", fontWeight: 300, color: "rgba(255,255,255,0.9)", lineHeight: 1.85, marginBottom: "32px" }}>Hardscape is structural work, not decorative work. A driveway or patio that fails within five years is a subbase problem — inadequate compaction, incorrect drainage slope, or undersized aggregate layers. We engineer every hardscape system from the ground up, ensuring that your investment performs structurally for decades while maintaining the aesthetic quality that Marin County properties demand.</p>
        <p style={{ fontFamily: MS, fontSize: "12px", letterSpacing: "0.07em", color: "rgba(255,255,255,0.45)", lineHeight: 1.9 }}>ConstruBay (CSLB #1106798) is based in Mill Valley and has executed driveway and hardscape projects across Marin, Sonoma, and Napa Counties.</p>
      </section>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "96px 24px" }}>
        ...
        <p style={{ fontFamily: MS, fontSize: "14px", lineHeight: 1.95, color: "rgba(255,255,255,0.7)", letterSpacing: "0.03em" }}>Driveway and hardscape construction in Marin County is increasingly subject to low-impact development (LID) requirements that mandate permeable surfaces for new or significantly modified driveways above a certain area threshold. Our team is current on Marin County&apos;s stormwater management requirements and can design permeable paver systems that satisfy both LID compliance and the aesthetic standards of luxury Marin properties. For hillside lots in Mill Valley, Tiburon, and Ross, we engineer driveway subbase systems that account for soil instability, slope drainage, and seismic settlement — common challenges in Marin County that require engineering experience rather than standard residential construction practice.</p>
      </section>
      ...
      <section style={{ maxWidth: "680px", margin: "0 auto", padding: "96px 24px", textAlign: "center" }}>
        ...
        <div style={{ border: "1px solid rgba(203,178,106,0.25)", padding: "48px 32px", marginBottom: "28px" }}>
          <p style={{ fontFamily: CG, fontSize: "clamp(1.8rem, 4vw, 2.6rem)", fontWeight: 300, color: "#ffffff", marginBottom: "8px" }}>$35,000 – $150,000+</p>
      ...
      <section style={{ padding: "120px 24px", textAlign: "center", backgroundColor: "#000000" }}>
        ...
        <h2 style={{ fontFamily: CG, fontSize: "clamp(2.5rem, 5vw, 4rem)", fontWeight: 300, background: GRAD, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", marginBottom: "24px", lineHeight: 1.1 }}>Begin Your Driveway &amp; Hardscape Project</h2>
