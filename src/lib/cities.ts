...
export const cities: City[] = [
  ...
  },
  {
    ...
    lng: -122.6367,
    tier: 'secondary',
    description: 'Petaluma\'s Victorian storefronts and riverside neighborhoods anchor one of Sonoma County\'s most distinctive communities — from its historic downtown corridor to the hillside estates that frame the city\'s rolling western edge.',
    neighborhoods: ['Downtown Petaluma', 'East Petaluma', 'Petaluma Hill', 'Oak Hill'],
    heroImage: '/images/hero/hero-bg-1.jpg',
  },
  {
    slug: 'sebastopol',
    ...
    lng: -122.8232,
    tier: 'secondary',
    description: 'Sebastopol\'s orchard-shaded neighborhoods and creative character attract discerning homeowners who value craftsmanship that honors the area\'s architectural heritage — from converted farmsteads to contemporary luxury residences.',
    neighborhoods: ['Downtown Sebastopol', 'Gold Ridge', 'Occidental Road', 'Laguna Road'],
    heroImage: '/images/hero/hero-bg-1.jpg',
  },
  {
    slug: 'marina',
    ...
    lng: -122.4900,
    tier: 'secondary',
    description: 'Marin\'s waterfront marina communities combine unobstructed bay views with a refined coastal character — drawing homeowners who seek contractors with the experience to build at the intersection of beauty and technical complexity.',
    neighborhoods: ['Sausalito Waterfront', 'Belvedere Cove', 'Tiburon Marina', 'Paradise Cay'],
    heroImage: '/images/hero/hero-bg-1.jpg',
  },
];
